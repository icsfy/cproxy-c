...
* **TProxy Mode:** Transparently proxies TCP and UDP traffic (IPv4/IPv6) with optional DNS override.
...
### 4. Attaching to a Running Daemon (e.g., Docker)
